let data = [
  {
    ...
    example: (
      <div>
        <div>
          <span className="yellow2">$primaryColor</span>
          <span>: rgb(55,55,55);</span>
        </div>
        <div>
          <span className="green2">background</span>
  ...
  },
  {
    ...
    example: (
      <div>
        <div>
          <span className="yellow2">.parent</span>
          <span>{"{ background:grey;"}</span>
        </div>
        <div>
          &emsp;&emsp;&emsp;&emsp;<span className="green2">child</span>
  ...
  },
  {
    ...
    example: (
      <div>
        ...
        <div>
          &emsp;&emsp;&emsp;&emsp;<span className="green2">&:hover</span>
          <span>{"{background:black}"}</span>
        </div>
        <div>
          &emsp;&emsp;&emsp;&nbsp;<span>{"}"}</span>
    ...
    example: (
      <div>
        <span className="yellow2">
          {" "}
          {"@mixin mixinName($parameter1,$parameter2)"}
        </span>
        <span>{"{"}</span>
        <div>
          &emsp;&emsp;<span>display:flex;</span>
          <br></br>
          &emsp;&emsp;
          <span>
            justify-content:<span className="green2"> {"$parameter1"}</span>;
          </span>
          <br></br>
          &emsp;&emsp;
          <span>
            align-items:<span className="green2"> {"$parameter2"}</span>;
          </span>
        </div>
        &emsp;&emsp;<span>{"}"}</span>
        <br></br>
        ...
        <span>{"{"}</span>
        <br></br>
        &emsp;&emsp;<span>@include mixinName(center, start);</span>
        <br></br>
        &emsp;&emsp;<span>{"}"}</span>
      </div>
    ),
